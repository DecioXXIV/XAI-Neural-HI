...
if __name__ == "__main__":
    ...
    explainer = setup_explainer(EXPERIMENT_ID, XAI_ALGORITHM, XAI_ENTRY, model, EXP_METADATA, FT_METADATA, XAI_METADATA, DEVICE)
    instance_paths, labels = InstanceToExplainRetriever(EXPERIMENT_ID, EXP_METADATA, SUBSAMPLE)()
    execute_pages_preprocessing(EXPERIMENT_ID, instance_paths, CROP_SIZE, XAI_ALGORITHM, XAI_ENTRY, EXP_METADATA, XAI_METADATA, EXPERIMENT_XAI_DIR, XAI_INSTANCES_METADATA)
