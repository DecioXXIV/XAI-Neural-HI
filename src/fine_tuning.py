...
if __name__ == "__main__":
    EXPERIMENT_ID, CROP_SIZE, BATCH_SIZE, CH_LAYERS, OPTIMIZER, LR, LR_SCHEDULER, LR_FINAL_DECAY_RATIO, EARLY_STOPPING, TRAIN_REPLICAS, RANDOM_SEED, EPOCHS, FT_MODE, KEEP_CROPS = get_ft_args()
    
    EXP_METADATA = get_experiment_metadata(EXPERIMENT_ID)
    FT_METADATA, FT_MH = get_ft_metadata(EXPERIMENT_ID)
    FT_METADATA = initialize_ft_metadata(FT_METADATA, FT_MH, BATCH_SIZE, CH_LAYERS, OPTIMIZER, LR, LR_SCHEDULER, LR_FINAL_DECAY_RATIO, EARLY_STOPPING, CROP_SIZE, TRAIN_REPLICAS, RANDOM_SEED, EPOCHS, FT_MODE, KEEP_CROPS)
