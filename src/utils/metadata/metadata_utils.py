...
def initialize_ft_metadata(ft_metadata: Dict[str, Any], ft_mh: MetadataHandler, batch_size: int, opt: str, lr: float, lr_scheduler: str, lr_final_decay_ratio: float, 
    ...
    if "HYPERPARAMETERS" not in ft_metadata:
        ft_metadata["HYPERPARAMETERS"] = {"batch_size": batch_size, "optimizer": opt, "lr": lr,  "lr_scheduler": lr_scheduler, "lr_final_decay_ratio": lr_final_decay_ratio,
